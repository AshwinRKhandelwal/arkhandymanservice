            ...
            <div class="service-heading-box">
                <div class="service-title">
                    ...
                    <div class="price d-flex align-items-center">
                        <h4 class="primary-color">{{serviceData.price_format}}</h4> <small v-if="serviceData.type =='hourly'">/hr</small> <span v-if="serviceData.discount" class="ps-2">{{serviceData.discount}}% {{__('messages.off')}}</span>
                    </div>
                </div>
             ...
             <div class="row">
                <div class="col-lg-8">
                    <div class="service-detail-info">                                
                        ...
                        <div v-if="realtedService.length > 0" class="service-related-product service-top-space">
                            <div class="header-title-inner-page d-flex align-items-center justify-content-between">
                                <h4 class="title">{{__('messages.realted_service')}}</h4>
                            </div>
                            <div class="relateservice our-service">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-xs-12" v-for="(data, index) in realtedService" :key="index"> 
                                    <service-list 
                                            :serviceId="data.id"
    ...
    methods:{
        serviceDetail(){
            ...
            .then((response) => {
                ...
                this.realtedService = response.data.related_service
            });
        }
    }
}
